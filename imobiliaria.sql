...
-- Copiando estrutura do banco de dados para imobiliaria.tcc
DROP DATABASE IF EXISTS `imobiliaria.tcc`;
CREATE DATABASE IF NOT EXISTS `imobiliaria.tcc` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `imobiliaria.tcc`;

-- Copiando estrutura para tabela imobiliaria.tcc.imagens_imoveis
...
-- Copiando dados para a tabela imobiliaria.tcc.imagens_imoveis: ~29 rows (aproximadamente)
...
-- Copiando estrutura para tabela imobiliaria.tcc.imovel
...
-- Copiando dados para a tabela imobiliaria.tcc.imovel: ~4 rows (aproximadamente)
DELETE FROM `imovel`;
...
-- Copiando estrutura para tabela imobiliaria.tcc.usuario
...
-- Copiando dados para a tabela imobiliaria.tcc.usuario: ~7 rows (aproximadamente)
DELETE FROM `usuario`;
